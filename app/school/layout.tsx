...
const navGroups: NavGroup[] = [
  ...
  },
  {
    label: 'Communication',
    items: [
      { href: '/school/whatsapp', label: 'WhatsApp & SMS', icon: '💬' },
    ]
  },
  {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="main-layout" style={{ flex: 1, position: 'relative' }}>
        ...
        {/* Content */}
        <main style={{ marginLeft: isMobile ? '0' : (collapsed ? '70px' : '260px'), flex: 1, minHeight: '100vh', width: '100%', transition: 'margin-left 0.25s ease', display: 'flex', flexDirection: 'column' }}>
          {/* Top Bar Header */}
          <header style={{
            display: 'flex',
